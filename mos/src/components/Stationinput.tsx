...
function StationInput({
  ...
  return station && line && stationid ? (
      ...
      <div className="flex items-center gap-[5px] w-[85%]">
        ...
        <div className="w-full overflow-hidden" ref={animdivtext}>
          <span
            ...
            style={{
              width: `${station.name.ru.length * 10}px`,
            }}
          >
            {station.name.ru}
          </span>
    ...
    >
      ...
      <div className="h-[20px] w-[20px] flex items-center border-solid border-[1px] border-[var(--primary-muted-color)] text-[var(--primary-muted-color)]! text-[0.75rem] font-sans! justify-center rounded-[999px]">
        {type}
      </div>
